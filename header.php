...
<html lang="pt_BR">
	<head>
		...
		<title>SIAFMSP - Sindicato dos Atletas Profissionais de Futebol do Município de São Paulo</title>
        ...
        <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/lib/owlcarousel/assets/owl.carousel.min.css">
